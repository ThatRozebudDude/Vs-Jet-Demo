...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'jet':
				frames = Paths.getSparrowAtlas('jet/jet');
				animation.addByPrefix('idle', 'JetIdleDance', 24, false);
				...
				addOffset('idle');
				addOffset("singUP", 128, 20);
				addOffset("singRIGHT", 4, -17);
				addOffset("singLEFT", 83, -6);
				addOffset("singDOWN", 117, -77);
		}
