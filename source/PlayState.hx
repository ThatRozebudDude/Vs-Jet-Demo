...
class PlayState extends MusicBeatState
{
	...
	public static var jetSongs:Array<String>;
	...
	override public function create()
	{
		...
		if (SONG.stage == null) {
			...
			if(jetSongs.contains(SONG.song.toLowerCase())) { stageCheck = 'jet'; }
		...
		if (stageCheck == 'jet')
		{
			...
			defaultCamZoom = 0.8;
			jetBG = new FlxSprite(-300,-270);
			jetBG.frames = Paths.getSparrowAtlas('jet/bg');
			jetBG.animation.addByPrefix('bop','The Shit',24,false);
			jetBG.antialiasing = true;
			add(jetBG);
	...
	function startCountdown():Void
	{
		...
		startTimer = new FlxTimer().start(Conductor.crochet / 1000, function(tmr:FlxTimer)
		{
			...
			{
				case 0:
					FlxG.sound.play('assets/sounds/intro3' + altSuffix + TitleState.soundExt, 1);
					if(meta != null){
						meta.start();
					}
				case 1:
					...
					FlxG.sound.play('assets/sounds/intro2' + altSuffix + TitleState.soundExt, 1);
				case 2:
					...
					FlxG.sound.play('assets/sounds/intro1' + altSuffix + TitleState.soundExt, 1);
				case 3:
					...
					FlxG.sound.play('assets/sounds/introGo' + altSuffix + TitleState.soundExt, 1);
				case 4:
			}
	...
	private function generateSong(dataPath:String):Void
	{
		...
		for (section in noteData)
		{
			...
			for (songNotes in section.sectionNotes)
			{
				...
				susLength = (susLength + 10) / Conductor.stepCrochet;
	...
	function camFocusOpponent(){
		...
		var followY = dad.getMidpoint().y - 75;
	...
	function camFocusBF(){
		...
		var followX = boyfriend.getMidpoint().x - 280;
		var followY = boyfriend.getMidpoint().y - 200;
